...
export default function Transfer({ drawers, setDrawers }) {
  return (
    <Drawer anchor={'right'} open={drawers.transfer} onClose={() => setDrawers(DRAWERS)}>
        ...
        <Box>
          ...
          <Box>
            <Typography variant="h5" sx={{ marginBottom: '40px' }}>
              Select the currency & source of funds you'd like to transfer. Then select the currency
